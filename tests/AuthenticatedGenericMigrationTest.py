...
class AuthenticatedGenericMigrationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = self.configutil.read_config_file('authenticated_test_data.ini')
    ...
    def test_selected_image_migration(self):
        ...
        # Create temp file with migration Configuration
        fd, path = tempfile.mkstemp()
        with open(path, 'w') as tmpFile:
            tmpFile.write(imagenamespace + '/' + imagename)
